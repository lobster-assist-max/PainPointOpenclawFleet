...
Fleet stores uploaded files (issue attachments, images) using a configurable storage provider.
...
```
~/.fleet/instances/default/data/storage
```
...
```
~/.fleet/instances/default/config.json
```

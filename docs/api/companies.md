...
Manage companies within your Fleet instance.
...
Company logo uploads use the normal Fleet attachment size limit.
...
| `logoUrl` | string | Optional Fleet asset content path for the stored logo image |

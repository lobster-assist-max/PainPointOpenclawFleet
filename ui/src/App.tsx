      ...
      {isError ? (
        ...
        <AuditLog
          ...
          onExportCsv={() => {
            ...
            a.href = fleetMonitorApi.auditExportUrl(selectedCompanyId);
...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? `Connect another bot to ${matchedCompany.name}`
    : companies.length > 0
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-4">
          ...
          >
            {matchedCompany ? "Connect Bot" : "Start Onboarding"}
          </Button>
        </div>
      </div>
    </div>
...
function NoCompaniesStartPage() {
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Create your first fleet</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Get started by creating a fleet and connecting your bots.
        </p>
        <div className="mt-4">
          <Button onClick={() => openOnboarding()}>New Fleet</Button>
        </div>
      </div>
    </div>
  );
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="time-machine" element={<UnprefixedBoardRedirect />} />
          ...
          <Route path="bots/:botId" element={<UnprefixedBoardRedirect />} />

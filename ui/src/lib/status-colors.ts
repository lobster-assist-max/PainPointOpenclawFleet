...
// ---------------------------------------------------------------------------
// Fleet — Bot connection state colors
// ---------------------------------------------------------------------------

/** Background dot for bot connection state indicators */
export const botConnectionDot: Record<string, string> = {
  monitoring: "bg-green-400",
  connecting: "bg-cyan-400 animate-pulse",
  authenticating: "bg-cyan-400 animate-pulse",
  disconnected: "bg-yellow-400 animate-pulse",
  backoff: "bg-orange-400",
  error: "bg-red-400",
  dormant: "bg-neutral-400",
};

export const botConnectionDotDefault = "bg-neutral-400";

/** Badge variant for bot connection states */
export const botConnectionBadge: Record<string, string> = {
  monitoring: "bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300",
  connecting: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
  authenticating: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
  disconnected: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/50 dark:text-yellow-300",
  backoff: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  error: "bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300",
  dormant: "bg-muted text-muted-foreground",
};

export const botConnectionBadgeDefault = "bg-muted text-muted-foreground";

/** Health grade → color class */
export const healthGradeColor: Record<string, string> = {
...
export const healthGradeColorDefault = "text-muted-foreground";

/** Channel type → brand color class */
export const channelBrandColor: Record<string, string> = {
  line: "text-[#00B900]",
...
export const channelBrandColorDefault = "text-muted-foreground";
...
export const alertSeverityBadgeDefault = "bg-muted text-muted-foreground";

 ...
 *
 * This is placed on `globalThis.__fleetPluginBridge__` and consumed by
...
declare global {
  ...
  var __fleetPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__fleetPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__fleetPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,

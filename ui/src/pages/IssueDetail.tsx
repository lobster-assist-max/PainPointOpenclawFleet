...
const ACTION_LABELS: Record<string, string> = {
  ...
  "agent.created": "connected a bot",
  "agent.updated": "updated the bot",
  "agent.paused": "paused the bot",
  "agent.resumed": "resumed the bot",
  "agent.terminated": "terminated the bot",
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`fleet:issue-comment-draft:${issue.id}`}
            enableReassign

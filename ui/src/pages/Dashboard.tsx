...
export function Dashboard() {
  ...
  if (!selectedCompanyId) {
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message="Welcome to PainPoint Fleet. Set up your first fleet and bot to get started."
          action="Get Started"
    ...
    return (
      <EmptyState icon={LayoutDashboard} message="Create or select a fleet to view the dashboard." />
    );
  }
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {data.budgets.pausedAgents} bots paused · {data.budgets.pausedProjects} projects paused · {data.budgets.pendingApprovals} pending budget approvals
                  </p>
                </div>
              </div>

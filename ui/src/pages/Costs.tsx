...
export function Costs() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={DollarSign} message="Select a fleet to view costs." />;
  }
          ...
          {showCustomPrompt ? (
            ...
            <>
              ...
              <div className="grid gap-4 xl:grid-cols-[1.25fr,0.95fr]">
                <Card>
                  <CardHeader className="px-5 pt-5 pb-2">
                    <CardTitle className="text-base">By bot</CardTitle>
                    <CardDescription>What each bot consumed in the selected period.</CardDescription>
                  </CardHeader>
              ...
              <Card className="border-border/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))]">
                ...
                <CardContent className="grid gap-3 px-5 pb-5 pt-0 md:grid-cols-4">
                  ...
                  <MetricTile
                    ...
                    subtitle="Bot heartbeats blocked by budget"
                    icon={Coins}
                  />
                  <MetricTile
                ...
                {(["company", "agent", "project"] as const).map((scopeType) => {
                  ...
                  return (
                    <section key={scopeType} className="space-y-3">
                      <div>
                        <h2 className="text-lg font-semibold capitalize">{{ company: "fleet", agent: "bot", project: "project" }[scopeType]} budgets</h2>
                        <p className="text-sm text-muted-foreground">
                          {scopeType === "company"
                            ? "Fleet-wide monthly policy."
                            : scopeType === "agent"
                              ? "Recurring monthly spend policies for individual bots."

...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: "Connect a new bot",
      description: "(type in what kind of bot you want here)",
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">Connect a new bot</span>
          <Button
            variant="ghost"
            size="icon-xs"
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  We recommend letting your CEO handle bot setup — they know the
              ...
              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                ...
                Ask the CEO to connect a new bot
              </Button>

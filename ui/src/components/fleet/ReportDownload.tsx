...
export function ReportDownload({ companyId, className }: ReportDownloadProps) {
  ...
  return (
    <div className={cn("rounded-xl border p-4 space-y-4", className)}>
      ...
      {/* Error message */}
      {downloadError && (
        <div className="flex items-center gap-2 rounded-lg bg-red-500/10 dark:bg-red-950/30 border border-red-500/20 dark:border-red-500/30 px-3 py-2 text-xs text-red-600 dark:text-red-400">

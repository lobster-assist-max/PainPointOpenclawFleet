...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("fleet-project-mention-chip");
      ...
      link.classList.add("fleet-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative fleet-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("fleet-mdxeditor", !bordered && "fleet-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "fleet-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />

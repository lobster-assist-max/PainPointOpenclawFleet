...
function requireCapability(manifest: FleetPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Fleet server runtime.
 */

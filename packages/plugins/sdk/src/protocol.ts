 ...
 * channel.
 *
 * The Fleet plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all Fleet messages.
 */
...
/**
 * Fleet plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Fleet instance. */
    instanceId: string;
    /** Semver version of the running Fleet host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;

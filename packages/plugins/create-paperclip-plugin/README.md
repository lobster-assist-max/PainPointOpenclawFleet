...
npx @painpoint/create-fleet-plugin @acme/my-plugin \
  ...
  --description "Syncs Acme data into Fleet" \
  --author "Acme Inc"
```
...
Outside this repo, the scaffold snapshots `@paperclipai/plugin-sdk` from your local Fleet checkout into a `.fleet-sdk/` tarball and points the generated package at that local file by default. You can override the SDK source explicitly:

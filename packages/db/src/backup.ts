...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveFleetHomeDir(), "instances", resolveFleetInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveFleetHomeDir(), "instances", resolveFleetInstanceId(), "data", "backups");
}

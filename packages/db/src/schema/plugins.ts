...
import type { PluginCategory, PluginStatus, FleetPluginManifestV1 } from "@paperclipai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<FleetPluginManifestV1>().notNull(),

...
- **Commit Co-author**: if you make a git commit you MUST add `Co-Authored-By: Fleet <noreply@paperclip.ing>` to the end of each commit message
...
```bash
pnpm fleet heartbeat run --agent-id "$PAPERCLIP_AGENT_ID"
```

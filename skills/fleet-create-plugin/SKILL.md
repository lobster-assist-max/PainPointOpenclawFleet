...
# Create a Fleet Plugin

Use this skill when the task is to create, scaffold, or document a Fleet plugin.
...
- is installed into Fleet from an absolute local path during development

...
name: release
description: >
  Coordinate a full Fleet release across engineering verification, npm,
...
Run the full Fleet maintainer release workflow, not just an npm publish.
...
7. If running through Fleet, you have issue context for status updates and follow-up task creation.
...
Fleet now uses a commit-driven release model:
...
- release summary in Fleet issue context

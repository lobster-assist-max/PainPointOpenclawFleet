...
This document covers the GitHub and npm setup required for the current Fleet release model:
...
Do this for every public package that Fleet publishes.
...
2. revoke any personal automation token that used to publish Fleet

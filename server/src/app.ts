...
import { fleetCustomerJourneyRoutes } from "./routes/fleet-customer-journey.js";
import { fleetMetaLearningRoutes } from "./routes/fleet-meta-learning.js";
import { fleetSandboxRoutes } from "./routes/fleet-sandbox.js";
import { fleetAnomalyCorrelationRoutes } from "./routes/fleet-anomaly-correlation.js";
import { fleetMemoryMeshRoutes } from "./routes/fleet-memory-mesh.js";
import { fleetDeploymentRoutes } from "./routes/fleet-deployments.js";
...
import { fleetA2ARoutes } from "./routes/fleet-a2a.js";
import { fleetConversationAnalyticsRoutes } from "./routes/fleet-conversation-analytics.js";
import { fleetCostOptimizerRoutes } from "./routes/fleet-cost-optimizer.js";
import { fleetPromptRoutes } from "./routes/fleet-prompts.js";
...
import { getAnomalyCorrelationEngine } from "./services/fleet-anomaly-correlation-singleton.js";
import { getMemoryMeshEngine } from "./services/fleet-memory-mesh-singleton.js";
...
export async function createApp(
  ...
  api.use("/fleet-alerts", fleetAlertRoutes(db));
  ...
  api.use("/fleet-monitor", fleetAnomalyCorrelationRoutes(getAnomalyCorrelationEngine()));
  ...
  api.use("/fleet-monitor", fleetCostOptimizerRoutes());
  ...
  if (opts.uiMode === "static") {
    ...
    if (uiDist) {
      ...
      console.warn("[fleet] UI dist not found; running in API-only mode");
    }
  }

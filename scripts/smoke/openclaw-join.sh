...
FLEET_API_URL="${FLEET_API_URL:-${PAPERCLIP_API_URL:-http://localhost:3100}}"
API_BASE="${FLEET_API_URL%/}/api"
COMPANY_ID="${COMPANY_ID:-${FLEET_COMPANY_ID:-${PAPERCLIP_COMPANY_ID:-}}}"
...
Provide one of:
  FLEET_AUTH_HEADER=\"Bearer <board-token>\"
  FLEET_COOKIE=\"<board-session-cookie>\"
